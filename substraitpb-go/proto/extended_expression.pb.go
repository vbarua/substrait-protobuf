...
func (x *ExpressionReference) GetExprType() isExpressionReference_ExprType {
	if x != nil {
		return x.ExprType
	}
	return nil
...
func (x *ExpressionReference) GetExpression() *Expression {
	if x != nil {
		if x, ok := x.ExprType.(*ExpressionReference_Expression); ok {
			return x.Expression
		}
	}
	return nil
...
func (x *ExpressionReference) GetMeasure() *AggregateFunction {
	if x != nil {
		if x, ok := x.ExprType.(*ExpressionReference_Measure); ok {
			return x.Measure
		}
	}
	return nil
