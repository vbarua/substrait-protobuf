...
func (x *SimpleExtensionDeclaration) GetExtensionType() *SimpleExtensionDeclaration_ExtensionType {
	if x != nil {
		if x, ok := x.MappingType.(*SimpleExtensionDeclaration_ExtensionType_); ok {
...
func (x *SimpleExtensionDeclaration) GetExtensionTypeVariation() *SimpleExtensionDeclaration_ExtensionTypeVariation {
	if x != nil {
		if x, ok := x.MappingType.(*SimpleExtensionDeclaration_ExtensionTypeVariation_); ok {
...
func (x *SimpleExtensionDeclaration) GetExtensionFunction() *SimpleExtensionDeclaration_ExtensionFunction {
	if x != nil {
		if x, ok := x.MappingType.(*SimpleExtensionDeclaration_ExtensionFunction_); ok {
...
var file_substrait_extensions_extensions_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0x62, 0x0a, 0x12, 0x69, 0x6f, 0x2e, 0x73, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75,
