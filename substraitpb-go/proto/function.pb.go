...
type FunctionSignature_Scalar struct {
	...
	// Types that are valid to be assigned to FinalVariableBehavior:
	//
...
func (x *FunctionSignature_Scalar) GetFinalVariableBehavior() isFunctionSignature_Scalar_FinalVariableBehavior {
	if x != nil {
		return x.FinalVariableBehavior
	}
	return nil
}
...
func (x *FunctionSignature_Scalar) GetVariadic() *FunctionSignature_FinalArgVariadic {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Scalar_Variadic); ok {
			return x.Variadic
		}
	}
	return nil
...
func (x *FunctionSignature_Scalar) GetNormal() *FunctionSignature_FinalArgNormal {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Scalar_Normal); ok {
			return x.Normal
		}
	}
	return nil
...
func (x *FunctionSignature_Aggregate) GetFinalVariableBehavior() isFunctionSignature_Aggregate_FinalVariableBehavior {
	if x != nil {
		return x.FinalVariableBehavior
	}
	return nil
...
func (x *FunctionSignature_Aggregate) GetVariadic() *FunctionSignature_FinalArgVariadic {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Aggregate_Variadic); ok {
			return x.Variadic
		}
	}
	return nil
...
func (x *FunctionSignature_Aggregate) GetNormal() *FunctionSignature_FinalArgNormal {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Aggregate_Normal); ok {
			return x.Normal
		}
	}
	return nil
...
func (x *FunctionSignature_Window) GetFinalVariableBehavior() isFunctionSignature_Window_FinalVariableBehavior {
	if x != nil {
		return x.FinalVariableBehavior
	}
	return nil
...
func (x *FunctionSignature_Window) GetVariadic() *FunctionSignature_FinalArgVariadic {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Window_Variadic); ok {
			return x.Variadic
		}
	}
	return nil
...
func (x *FunctionSignature_Window) GetNormal() *FunctionSignature_FinalArgNormal {
	if x != nil {
		if x, ok := x.FinalVariableBehavior.(*FunctionSignature_Window_Normal); ok {
			return x.Normal
		}
	}
	return nil
...
type FunctionSignature_Argument struct {
	...
	// Types that are valid to be assigned to ArgumentKind:
	//
...
func (x *FunctionSignature_Argument) GetArgumentKind() isFunctionSignature_Argument_ArgumentKind {
	if x != nil {
...
func (x *FunctionSignature_Argument) GetValue() *FunctionSignature_Argument_ValueArgument {
	if x != nil {
		if x, ok := x.ArgumentKind.(*FunctionSignature_Argument_Value); ok {
			return x.Value
		}
	}
	return nil
...
func (x *FunctionSignature_Argument) GetType() *FunctionSignature_Argument_TypeArgument {
	if x != nil {
		if x, ok := x.ArgumentKind.(*FunctionSignature_Argument_Type); ok {
			return x.Type
		}
	}
	return nil
...
func (x *FunctionSignature_Argument) GetEnum() *FunctionSignature_Argument_EnumArgument {
	if x != nil {
		if x, ok := x.ArgumentKind.(*FunctionSignature_Argument_Enum); ok {
			return x.Enum
		}
	}
	return nil
...
var file_substrait_function_proto_rawDesc = []byte{
	...
	0x0d, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x42, 0x57,
	...
	0x73, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x2d, 0x67, 0x6f, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0xaa, 0x02, 0x12, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x2e, 0x50,
